...
parcelRequire = (function (modules, cache, entry, globalName) {
  ...
  return newRequire;
})({"assets/js.png":[function(require,module,exports) {
module.exports = "/js.67e058f9.png";
...
var _js = _interopRequireDefault(require("./assets/js.png"));

var _blocks = require("./classes/blocks");

function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }

var text = "Using this application you can implement dynamic features on web page. It possible thanks to programming language JavaScript.";
var model = [new _blocks.TitleBlock('Web-site builder on pure JavaScript', {
  tag: 'h2',
  styles: {
...
}), new _blocks.ColumnsBlock(['Pure JavaScript application without any framework', 'JavaScript is a dynamic computer programming language', 'JavaScript is used across the web development stack'], {
  styles: {
...
exports.model = model;
},{"./assets/js.png":"assets/js.png","./classes/blocks":"classes/blocks.js"}],"classes/site.js":[function(require,module,exports) {
"use strict";
